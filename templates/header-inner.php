...
<head>
    ...
    <title><?= htmlspecialchars($pageTitle ?? "TT Devassy Jewellery") ?></title>
                    ...
                    <div class="row">
                        <div class="col-lg-3">
                            <div class="header-logo">
                                <a href="index.php">
                                    <img src="assets/images/logob.svg" alt="TT Devassy Jewellery">
                                </a>
                            </div>
                        </div>
                        <div class="col-lg-9">
                            ...
                            <div class="main-menu_area">
                                <nav>
                                    <ul>
                                        ...
                                        <li class="megamenu-holder"><a href="shop-left-sidebar.php">Shop</a>
                                            <ul class="hm-megamenu">
                                                <li><span class="megamenu-title">Shop Page Layout</span>
                                                    <ul>
                                                        <li><a href="shop-3-column.php">Grid Fullwidth</a></li>
                                                        ...
                                                        <li><a href="shop-list-right-sidebar.php">List Right Sidebar</a>
                                                        </li>
                                                    </ul>
                                                </li>
                                                <li><span class="megamenu-title">Single Product Style</span>
                                                    <ul>
                                                        ...
                                                        <li><a href="single-product-gallery-right.php">Gallery Right</a>
                                                        </li>
                                                        <li><a href="single-product-tab-style-left.php">Tab Style Left</a>
                                                        </li>
                                                ...
                                                <li><span class="megamenu-title">Single Product Type</span>
                                                    <ul>
                                                        ...
                                                        <li><a href="single-product-variable.php">Single Product Variable</a>
                                                        </li>
                                                        <li><a href="single-product-affiliate.php">Single Product
                                                                Affiliate</a>
                                                        </li>
                                                        <li><a href="single-product-slider.php">Single Product Slider</a>
                                                        </li>
                                                    </ul>
                                                </li>
                                        ...
                                        <li><a href="blog-left-sidebar.php">Blog</a>
                                            <ul class="hm-dropdown">
                                                ...
                                                <li><a href="blog-list-left-sidebar.php">List View</a>
                                                    <ul class="hm-dropdown hm-sub_dropdown">
                                                        ...
                                                        <li><a href="blog-list-right-sidebar.php">List Right Sidebar</a>
                                                        </li>
                                                    </ul>
                                                </li>
                                        ...
                                        <li><a href="index.php">Pages</a>
                                            <ul class="hm-dropdown">
                                                ...
                                                <li><a href="coming-soon_page.php">Comming Soon</a></li>
                                            </ul>
                                        </li>
                                        <li><a href="about-us.php">About Us</a></li>
                                        <li><a href="contact.php">Contact</a></li>
                                        <li><a href="shop-left-sidebar.php">Jewellery</a></li>
                                    </ul>
                                </nav>
                            </div>
                        </div>
        ...
        <div class="breadcrumb-area">
            <div class="container">
                <div class="breadcrumb-content">
                    <h2><?= htmlspecialchars($breadcrumb ?? "Page") ?></h2>
                    <ul>
                        <li><a href="index.php">Home</a></li>
                        <li class="active">><?= htmlspecialchars(
                            $breadcrumb ?? "Page",
                        ) ?></li>
                    </ul>
                </div>
